...
final class ClaudeCodeMonitorSmokeTests: XCTestCase {
    func testRefreshNowBuildsClaudeStateFromTempSessionTranscriptBridgeAndPresentation() throws {
        ...
        XCTAssertEqual(state.threads.first?.taskLabel, "Inspect Claude state chain")
        XCTAssertEqual(state.threads.first?.detail, "等待批准 Bash")
        ...
        XCTAssertEqual(presentation.visibleThreads.first?.detailCopy, "等待批准 Bash")
